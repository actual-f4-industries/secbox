...
// Ported from sbox-public/engine/Sandbox.Access/Rules/*.cs and Config/*.cs.
// Re-run the rule sync tool whenever Facepunch updates these files.
// Format: "AssemblyName/MemberPath" with `*` wildcards, `!` prefix = deny.
public static class EngineMirrorData
{
    public static int TotalRuleCount =>
        BaseAccess.Length + Types.Length + Reflection.Length + Async.Length +
        Exceptions.Length + Diagnostics.Length + CompilerGenerated.Length;

    public static readonly string[] Assemblies = new[]
    {
    ...
    public static readonly string[] BaseAccess = new[]
    {
        "Sandbox.Engine/*",
        "Sandbox.System/*",
        "Sandbox.Filesystem/*",
    ...
    public static readonly string[] Reflection = new[]
    {
    ...
    public static readonly string[] Async = new[]
    {
    ...
    public static readonly string[] Exceptions = new[]
    {
    ...
    public static readonly string[] Diagnostics = new[]
    {
    ...
    public static readonly string[] CompilerGenerated = new[]
    {
